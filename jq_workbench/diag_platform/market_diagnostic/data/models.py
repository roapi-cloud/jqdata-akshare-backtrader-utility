...
All models include type annotations and are compatible with JSON serialization.
"""
...
class MarketBreadthData:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "explode_count": self.explode_count,
            "seal_rate": self.seal_rate,
            "continuous_limit_up": self.continuous_limit_up,
            "above_ma20_ratio": self.above_ma20_ratio,
            "above_ma60_ratio": self.above_ma60_ratio,
            "new_high_count": self.new_high_count,
            "new_low_count": self.new_low_count,
            "total_amount": self.total_amount,
            "amount_ma5": self.amount_ma5,
            "amount_ma20": self.amount_ma20,
        }
...
class SectorDailyData:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "excess_ret_1d": self.excess_ret_1d,
            "breadth_20": self.breadth_20,
            "new_high_ratio": self.new_high_ratio,
            "amount": self.amount,
            "amount_share": self.amount_share,
            "amount_share_delta": self.amount_share_delta,
            "limit_up_count": self.limit_up_count,
