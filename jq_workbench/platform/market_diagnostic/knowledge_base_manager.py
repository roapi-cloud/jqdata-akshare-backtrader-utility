...
class DiagnosticReport:
    ...
    def get_regime_display_name(self) -> str:
        ...
        return names.get(self.composite_regime, self.composite_regime)
...
class KnowledgeBaseManager:
    ...
    def __init__(
        ...
        if base_path:
            ...
            # Use jq_workbench/knowledge as default
            default_base = Path(__file__).parent.parent.parent / "knowledge"
            self.base_path = default_base
            self.diagnostic_reports_path = default_base / "diagnostic_reports"
            self.regime_patterns_path = default_base / "regime_patterns"
            self.strategy_mapping_path = default_base / "strategy_mapping"
    ...
    def save_report(
        ...
        date : str, optional
            Report date in YYYY-MM-DD format. Uses today if not provided.
        format : str
    ...
    def get_regime_timeline(
        ...
        for report in reports:
            ...
            timeline.append(TimelineEntry(
                ...
                regime=regime,
                display_name=display_names.get(regime, regime),
    ...
    def generate_regime_distribution_text(
        ...
        display_names = {
            "trend_risk_on_growth": "趋势进攻·成长",
            "trend_risk_on_smallcap": "趋势进攻·小盘",
            "balanced_rotation": "均衡轮动",
            "defensive_dividend": "防守·红利",
            "high_volatility_warning": "高波动预警",
            "panic_bottoming": "恐慌探底",
            "broad_weakness_hold": "全面弱势",
        }
        ...
        for stat in stats:
            ...
            name = display_names.get(stat.regime, stat.regime)
            lines.append(
                f"{name:20s} {bar} {pct:5.1f}% ({stat.count}次) "
...
def get_knowledge_base(base_path: str = None) -> KnowledgeBaseManager:
    """
